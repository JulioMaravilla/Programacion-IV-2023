            ...
            <div class="card text-white" id="carMatricula">
                ...
                <div class="card-body text-dark">
                    <form method="post" @submit.prevent="guardarMatricula" @reset="nuevoMatricula">
                        ...
                        <div class="row p-1">
                            <div class="col col-md-2">Codigo Estudiante:</div>
                            <div class="col col-md-2">
                                <input title="Ingrese el codigo" v-model="matricula.codigo" pattern="[A-Z0-9]{10}" required type="text" class="form-control">
                            </div>
                        </div>
